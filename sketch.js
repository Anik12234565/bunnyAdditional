...
function setup() 
{
  ...
  starDisplay.addImage(emptyStar);
  starDisplay.addImage(twoStar);
  starDisplay.addImage(oneStar);
  starDisplay.scale = 0.2;
  starDisplay.changeImage(emptyStar);
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide(fruit,star,20)==true) {
     star.visible = false;
     starDisplay.changeImage(oneStar);
   }
